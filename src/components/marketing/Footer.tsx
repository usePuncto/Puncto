...
const footerLinks = {
  ...
  suporte: [
    ...
    { name: 'Comunidade', href: 'https://discord.gg/GGX2mBejDf' },
...
const socialLinks = [
  {
    name: 'Discord',
    href: 'https://discord.gg/GGX2mBejDf',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/people/Puncto/61587093252643/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/usepuncto',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    href: 'https://www.tiktok.com/@usepuncto',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
